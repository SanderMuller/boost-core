...
| A Laravel application                 | [`sandermuller/project-boost-laravel`](https://github.com/sandermuller/project-boost-laravel) | `laravel/boost` MCP coexistence + tag filter + remote skills + origin tracing           |
...
| `BOOST_STRICT_ENTRY_POINT=1` | Refuse a bare command a wrapper covers, instead of warning (default in the next major) |
