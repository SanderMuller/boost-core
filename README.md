...
| `boost doctor`                       | Offline health check — config, remote sources, cache state, emitter status, leaked conventions tokens (0.16.0), unrenderable sources (0.18.0) | [Remote skill sources](#remote-skill-sources)               |
