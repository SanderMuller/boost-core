<!-- GENERATED by boost — do not edit. Change .ai/ (guidelines, skills) or .config/boost.php (conventions, agents, tags), then run `vendor/bin/boost sync`. Direct edits to this file are overwritten on the next sync. -->
